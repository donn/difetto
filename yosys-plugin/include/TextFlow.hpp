// Difetto: Modified to store string_views instead
...
namespace TextFlow {
    ...
    public:
        class iterator {
            ...
            std::string_view line() const { return m_column.m_strings[m_stringIndex]; }
        ...
        public:
            ...
            auto operator *() const -> std::string {
                ...
                return addIndentAndSuffix(copy.substr(m_pos, m_len));
            }
        ...
        explicit Column( std::string_view const& text ) { m_strings.push_back( text ); }
